...
java -version:"1.7" -Dedu.vt.ipg.dataadapter.logfile="C:\VLDS_DataAdapter_Logs\DOEDataAdapter" -Dedu.vt.ipg.dataadapter.website.portnum=10090 -Dedu.vt.ipg.dataadapter.webservices.portnum=10443 -Dedu.vt.ipg.dataadapter.runfrom=cmdline -Dedu.vt.ipg.dataadapter.clientcert=false -cp WEB-INF\lib\*;WEB-INF\classes edu.vt.ipg.dataadapter.App
